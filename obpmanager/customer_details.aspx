<%@ Page Title="" Language="C#" MasterPageFile="~/obpmanager/MasterObpManager.master" AutoEventWireup="true" CodeFile="customer_details.aspx.cs" Inherits="obpmanager_customer_details" %>
        ...
        <div>
            <asp:GridView ID="gvGOBPIncentive" runat="server" CssClass="table table-striped table-bordered table-hover table-responsive-sm" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SaleBill" HeaderText="Sale Bill">
                        <ItemStyle Width="10%" />
                    </asp:BoundField>
