<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="obpmanager_Default" %>
                ...
                <div class="login-box">
                    ...
                    <div class="card">
                        <div class="card-body login-card-body">
                            <p class="login-box-msg"><b>GOBP Manager LogIn</b></p>
                            <div class="input-group mb-3">
                                <asp:TextBox ID="txtUserID" runat="server" class="form-control" Placeholder="User Id" MaxLength="15"></asp:TextBox>
