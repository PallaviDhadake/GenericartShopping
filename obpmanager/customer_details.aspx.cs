...
public partial class obpmanager_customer_details : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    private void FillGrid()
    {
        try
        {
            ...
            strQuery = @"SELECT
                        ...
                        AND [OrderStatus] Not in ('0', '2', '4', '8', '9', '10', '11') AND (YEAR(OD.[OrderDate]) = " + yearData + " And MONTH(OD.[OrderDate]) = " + monthNumber + ") AND OBP.[OBP_ID] = " + Request.QueryString["id"].ToString() + " order by PD.[ProductName] ASC";
    ...
    protected void gvGOBPIncentive_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {            
            ...
            else if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[4].Text = billAmount.ToString();
                e.Row.Cells[4].Font.Bold = true;

                e.Row.Cells[5].Text = totalGST.ToString();
                ...
                e.Row.Cells[8].Text = incentiveAmount.ToString();
    ...
    private void ExportOrdersToExcel()
    {
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                // Removed and ODT.[OBPComPercent] IS NOT NULL and ODT.[OBPComPercent] > 0
