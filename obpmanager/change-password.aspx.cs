...
public partial class obpmanager_change_password : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtOld.Text == c.GetReqData("OBPManager", "OBPManPass", "OBPManID=" + Session["adminObpManager"] + "").ToString())
            {
                ...
                else
                {
                    ...
                    {
                        c.ExecuteQuery("Update OBPManager Set OBPManPass='" + txtNew.Text + "' Where OBPManID=" + Session["adminObpManager"] + "");
