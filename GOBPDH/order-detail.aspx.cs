...
public partial class GOBPDH_order_detail : System.Web.UI.Page
{
    iClass c = new iClass();
    public string customerId, errMsg, orderCount, shippingCharges, prescriptionStr, rdrUrl, mreq, assignDetails, gobpName;
    ...
    public void GetOrdersData(int Idx)
    {
        try
        {
            ...
            using (DataTable dtProduct = c.GetDataTable("Select a.OrdDetailID, a.FK_DetailProductID, a.OrdDetailQTY, 'Rs. ' + Convert(varchar(20), a.OrdDetailPrice)  as OrigPrice, 5 AS 'DHNetPaisaComm', a.OrdDetailAmount * 5/ 100 as 'DHNetPaisaCommAmt', 'Rs. ' + Convert(varchar(20), a.OrdDetailAmount) as OrdAmount , a.OrdDetailSKU, b.ProductName from OrdersDetails a Inner Join ProductsData b on a.FK_DetailProductID = b.ProductID where a.FK_DetailOrderID =" + Idx))
            {
