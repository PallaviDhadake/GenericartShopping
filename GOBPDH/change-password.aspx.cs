...
public partial class GOBPDH_change_password : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtOld.Text == c.GetReqData("[dbo].[DistrictHead]", "[DistHdPass]", "[DistHdId] = " + Session["adminGOBPDH"] + "").ToString())
            {
                ...
                else
                {
                    ...
                    {
                        c.ExecuteQuery("Update [dbo].[DistrictHead] Set [DistHdPass] = '" + txtNew.Text + "' Where [DistHdId] = " + Session["adminGOBPDH"] + "");
