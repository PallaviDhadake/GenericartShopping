<%@ Page Title="" Language="C#" MasterPageFile="~/GOBPDH/MasterGOBPDH.master" AutoEventWireup="true" CodeFile="order-detail.aspx.cs" Inherits="GOBPDH_order_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
						...
						<div>
							<asp:GridView ID="gvOrderDetails" runat="server" CssClass="table table-striped table-bordered table-hover table-responsive-sm" GridLines="None"
								...
								<Columns>
									...
									<asp:BoundField DataField="DHNetPaisaComm" HeaderText="DH Comm.">
										<ItemStyle Width="10%" />
									</asp:BoundField>
									<asp:BoundField DataField="DHNetPaisaCommAmt" HeaderText="DH Comm. Amt">
										<ItemStyle Width="10%" />
									</asp:BoundField>
	...
	<a href="order-report.aspx" class="btn btn-sm btn-outline-dark">Back</a>
