...
public partial class orgmember_dashboard : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void GetCount()
    {
        try
        {
            ...
            arrCounts[0] = c.returnAggregate("Select Count(DistHdId) From DistrictHead where DelMark=0 AND OrgMemberZH='"+ OrgZonalmem + "'").ToString();
