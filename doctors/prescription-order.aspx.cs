...
public partial class doctors_prescription_order : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    private void FillGrid()
    {
        try
        {
            ...
            if (Request.QueryString["type"] != null)
            {
                ...
                {
                    //a.OrderStatus = 1 (NEW),  a.OrderStatus = 11 (Rejected by Doctor), a.OrderStatus = 12 (No Response by customer)
                    case "new":
                        strQuery = @"Select DISTINCT a.OrderID, a.OrderDate, a.FK_OrderCustomerID, convert(varchar(20), a.OrderDate, 103) as ordDate, isnull(a.DeviceType, '-') as DeviceType, b.CustomerName,
                             ...
                             On a.FK_OrderCustomerID = b.CustomrtID Where (a.OrderStatus = 1 OR  a.OrderStatus = 11 OR  a.OrderStatus = 12) AND a.OrderType=2 AND (b.CustomerFavShop IS NULL OR b.CustomerFavShop=0) Order By ordDate DESC, a.OrderID DESC";
                        break;
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                switch (e.Row.Cells[1].Text)
                {
                    ...
                    case "10":
                        ...
                        break;
                    case "11":
                        litStatus.Text = "<div class=\"ordDenied\">Doctor Rejected</div>" + favShopOrder;
                        break;
                    case "12":
                        litStatus.Text = "<div class=\"ordProcessing\">No Response</div>" + favShopOrder;
                        break;
                }
            }
        }
