...
public partial class doctors_shop_list : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    private void FillGrid()
    {
        try
        {
            using (DataTable dtShops = c.GetDataTable("Select a.FranchID, a.FranchShopCode, a.FranchName, a.FranchMobile, a.FranchPassword, a.FranchAddress, a.FranchPinCode, b.CityName From FranchiseeData a Inner Join CityData b On a.FK_FranchCityId=b.CityID Where a.FranchActive=1"))
            {
