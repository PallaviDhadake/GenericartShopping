<%@ Page Title="" Language="C#" MasterPageFile="~/doctors/MasterDoctor.master" AutoEventWireup="true" CodeFile="order-details.aspx.cs" Inherits="doctors_order_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
				...
				<div class="pad_20">
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<asp:DropDownList ID="ddrFranchisee" CssClass="form-control" runat="server">
								<asp:ListItem Value="0">-- Select Franchise --</asp:ListItem>
							</asp:DropDownList>
							<%--<asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Width="100%" MaxLength="100"></asp:TextBox>--%>
						</div>
					</div>

					<div class="form-row">
						<div class="form-group col-md-6">
							<label>Other Shop Code :</label>
							<asp:TextBox ID="txtOtherShop" runat="server" CssClass="form-control" Width="100%" MaxLength="15" placeholder="Enter Shop Code"></asp:TextBox>
						</div>
					</div>
	...
	<asp:Button ID="btnAccept" runat="server" CssClass="btn btn-success float-left mr-lg-1" Text="Assign Order" OnClientClick="return confirm('Are you sure to Accept?');" OnClick="btnAccept_Click" />
	...
	<asp:Button ID="btnRejectOrder" runat="server" CssClass="btn btn-danger float-left mr-lg-1" Text="Reject Order" OnClientClick="return confirm('Are you sure to Reject?');" OnClick="btnRejectOrder_Click" />
	<asp:Button ID="btnResponse" runat="server" CssClass="btn btn-warning float-left mr-lg-1" Text="No Response" OnClientClick="return confirm('Are you sure to submit?');" OnClick="btnResponse_Click" />

	<div id="btnReject" runat="server" class="float-left mr-lg-1" visible="false"><a href="cancel-request-reason.aspx?id=<%= ordId %>" class="btn btn-danger cancel-links" onclientclick="return confirm('Are you sure to Reject?');">Reject</a></div>
