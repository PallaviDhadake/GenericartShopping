<%@ Page Title="Generic Mitra Customer's Order Report" Language="C#" MasterPageFile="~/genericmitra/MasterGenMitra.master" AutoEventWireup="true" CodeFile="order-reports.aspx.cs" Inherits="genericmitra_order_reports" %>
	...
	<script>
		$(document).ready(function () {
			$('[id$=gvOrder]').DataTable({
				columnDefs: [
					 { orderable: false, targets: [0, 1, 2, 3, 5, 4, 6, 8, 9, 10, 11] }
				],
				order: [[0, 'desc']]
			});
		});
