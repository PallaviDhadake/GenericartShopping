...
public partial class genericmitra_change_password : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtOld.Text == c.GetReqData("GenericMitra", "GMitraPassword", "GMitraID=" + Session["adminGenMitra"] + "").ToString())
            {
                ...
                else
                {
                    ...
                    {
                        c.ExecuteQuery("Update GenericMitra Set GMitraPassword='" + txtNew.Text + "' Where GMitraID=" + Session["adminGenMitra"] + "");
