<%@ Page Title="Add Customer | Generic Online Business Partner Panel" Language="C#" MasterPageFile="~/obp/MasterObp.master" AutoEventWireup="true" CodeFile="add-customer.aspx.cs" Inherits="obp_add_customer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
		...
		<asp:GridView ID="gvCustomer" runat="server" AutoGenerateColumns="False"
			...
			<Columns>
				...
				<asp:TemplateField>
					<ItemStyle Width="10%" />
					<ItemTemplate>
						<asp:Button ID="cmdSubmit" runat="server" CssClass="btn btn-sm btn-info" CommandName="gvSubmit" Text="Submit PO" />
					</ItemTemplate>
				</asp:TemplateField>
				<asp:TemplateField>
					<ItemStyle Width="10%" />
					<ItemTemplate>
						<asp:Button ID="cmdKnowMore" runat="server" CssClass="btn btn-sm btn-primary" CommandName="gvKnowMore" Text="Know Your Savings" />
					</ItemTemplate>
				</asp:TemplateField>
                <%--<asp:TemplateField HeaderText="Submit PO">
					<ItemStyle Width="10%" />
					<ItemTemplate>
						<asp:Literal ID="litPO" runat="server"></asp:Literal>
					</ItemTemplate>
				</asp:TemplateField>--%>
    ...
    <div id="initialBox" runat="server">
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-6">
						...
						<asp:TextBox ID="txtMob" runat="server" CssClass="form-control" Width="100%" MaxLength="10"></asp:TextBox>
					</div>
                </div>
            </div>
        </div>
				...
				<div class="card card-primary">
					...
					<div class="card-body">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<label>Country :*</label>
								<asp:TextBox ID="txtCountry" runat="server" CssClass="form-control" Width="100%" MaxLength="30" Enabled="false"></asp:TextBox>
							</div>
							<div class="form-group col-md-6">
								<label>State :*</label>
