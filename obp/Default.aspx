<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="obp_Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Genericart Shopping Online Business Partner Login </title>
                ...
                <div class="login-box">
                    ...
                    <div class="card">
                        <div class="card-body login-card-body">
                            <p class="login-box-msg"><b>Generic Online Business Partner LogIn</b></p>
                            <div class="input-group mb-3">
                                <asp:TextBox ID="txtUserID" runat="server" class="form-control" Placeholder="User Id" MaxLength="10"></asp:TextBox>
                            ...
                            <div class="input-group mb-3">
                                <asp:TextBox ID="txtPwd" runat="server" class="form-control" TextMode="Password" Placeholder="Password" MaxLength="10"></asp:TextBox>
                                <div class="input-group-append">
                                    <div class="input-group-text">
