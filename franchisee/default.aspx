<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="franchisee_default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Genericart Shopping Franchisee Login </title>
                ...
                <div class="login-box">
                    ...
                    <div class="card">
                        <div class="card-body login-card-body">
                            <p class="login-box-msg"><b>Franchisee LogIn</b></p>
                            <div class="input-group mb-3">
                                <asp:TextBox ID="txtShopCode" runat="server" class="form-control" Placeholder="Shop Code"></asp:TextBox>
