<%@ Page Title="Doctors Appointments" Language="C#" MasterPageFile="~/franchisee/MasterFranchisee.master" AutoEventWireup="true" CodeFile="doctor-appointments.aspx.cs" Inherits="franchisee_doctor_appointments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="viewApp" runat="server">
        <a href="<%= appUrl %>" class="btn btn-md btn-primary" target="_blank">Add New Appointment</a>
        <span class="space15"></span>
        <div>
