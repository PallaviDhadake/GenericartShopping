<%@ Page Title="Order Report Master | Genericart Shopping Franchisee Control Panel" Language="C#" MasterPageFile="~/franchisee/MasterFranchisee.master" AutoEventWireup="true" CodeFile="orders-report.aspx.cs" Inherits="franchisee_orders_report" %>
	...
	<div id="viewOrder" runat="server">
		...
		<div>
			<asp:GridView ID="gvOrder" runat="server" CssClass="table table-striped table-bordered table-hover table-responsive-sm" GridLines="None"
				AutoGenerateColumns="false" OnRowDataBound="gvOrder_RowDataBound" Width="100%" OnRowCommand="gvOrder_RowCommand">
				<RowStyle CssClass="" />
				...
				<Columns>
					...
					<asp:TemplateField HeaderText="Mark as Not Monthly Order">
						<ItemStyle Width="10%" />
						<ItemTemplate>
							<%--<asp:Button ID="cmdRemove" runat="server" CssClass="btn btn-mini" CommandName="gvRemove" Text="" />--%>
