...
public partial class franchisee_change_password : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string temp = Session["adminFranchisee"].ToString(); 
        ...
        try
        {
            if (txtOld.Text == c.GetReqData("FranchiseeData", "FranchPassword", "FranchID="+ temp).ToString())
            {
                ...
                else
                {
                    ...
                    {
                        c.ExecuteQuery("Update FranchiseeData Set FranchPassword='" + txtNew.Text + "' Where FranchID="+ temp);
