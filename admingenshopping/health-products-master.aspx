<%@ Page Title="Health Products Master | Genericart Shopping Admin Panel" Language="C#" MasterPageFile="~/admingenshopping/MasterAdmin.master" AutoEventWireup="true" CodeFile="health-products-master.aspx.cs" Inherits="admingenshopping_health_products_master" %>
<%@ MasterType VirtualPath="~/admingenshopping/MasterAdmin.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <script>
         $(document).ready(function () {
             $('[id$=gvHealthProd]').DataTable({
                 columnDefs: [
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="pgTitle">Health Products Master</h2>
            ...
            <div class="card-body">
                <div class="col-sm-7">
                    ...
                    <div class="form-group">
                        <label for="dName">Health Product Name:*</label>
    ...
    <div id="viewDisease" runat="server">
        <a href="health-products-master.aspx?action=new" class="btn btn-primary btn-sm">Add New</a>
        <span class="space25"></span>
        <asp:GridView ID="gvHealthProd" runat="server" AutoGenerateColumns="False"
            CssClass="table table-striped table-bordered table-hover" GridLines="None"  Width="100%" OnRowDataBound="gvHealthProd_RowDataBound">
            <RowStyle CssClass="" />
            <HeaderStyle CssClass="bg-dark" />
            <AlternatingRowStyle CssClass="alt" />
            <Columns>
                <asp:BoundField DataField="HealthProdId">
                    <HeaderStyle CssClass="HideCol" />
                    <ItemStyle CssClass="HideCol" />
                </asp:BoundField>
                <asp:BoundField DataField="HealthProdName" HeaderText="Health Product Name">
                    <ItemStyle Width="50%" />
                </asp:BoundField>
