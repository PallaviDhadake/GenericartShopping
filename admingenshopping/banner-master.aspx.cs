...
public partial class admingenshopping_banner_master : System.Web.UI.Page
{
    ...
    protected void gvBanner_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            litBanner.Text = "<img src=\"" + Master.rootPath + "upload/banner/" + e.Row.Cells[1].Text + "\" width=\"200\" height=\"100\" />";
