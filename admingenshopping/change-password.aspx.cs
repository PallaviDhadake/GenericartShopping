...
public partial class admingenshopping_change_password : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtOld.Text == c.GetReqData("AdminUsers", "UserPwd", "UserID=1").ToString())
            {
                ...
                else
                {
                    ...
                    {
                        c.ExecuteQuery("Update AdminUsers Set UserPwd='" + txtNew.Text + "' Where UserID=1");
