<%@ Page Title="Assign Order To Franchisee" Language="C#" MasterPageFile="~/admingenshopping/MasterAdmin.master" AutoEventWireup="true" CodeFile="assign-order.aspx.cs" Inherits="admingenshopping_assign_order" %>
<%@ MasterType VirtualPath="~/admingenshopping/MasterAdmin.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script>
        function delConfirm(btn) {
            btn.value = 'processing...';
            return confirm("Are you sure to Assign order to selected shop?");
        }
    </script>
    <script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="pgTitle">Assign Order</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="form_table">
                <tr>
                    <td><span class="formLable bold_weight">Order Id :</span></td>
        ...
        <div id="shopList" runat="server">
            <div class="card-header">
                <h3 class="medium colorLightBlue">Available Shops List to Assign Order</h3>
                ...
                <asp:GridView ID="gvShopList" runat="server" CssClass="table table-striped table-bordered table-hover table-responsive-sm" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="30%" />
                            <ItemTemplate>
                                <asp:Button ID="cmdAssign" runat="server" CssClass="buttonDel" CommandName="gvAssign" Text="Assign Order"   OnClientClick="return delConfirm(this);"/>
                            </ItemTemplate>
                        </asp:TemplateField>     
                    </Columns>
                    <EmptyDataTemplate>
                ...
                <div class="modal-body">
                    ...
                    <div class="box row-fluid">
                        <p class="total_price" style="text-align:right !important">
                            <b>Sub Total = &#8377; <%= ordData[6] %></b> <br />
                            <%--<b><%= shippingCharges %></b>--%>
                            <b>Total Amount = &#8377; <%= ordData[5] %></b>
                        </p>
                    </div>
