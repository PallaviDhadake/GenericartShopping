...
public partial class admingenshopping_mainitemcategory : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (lblId.Text == "[New]")
        {
            c.ExecuteQuery("Insert Into ProductCategory(ProductCatID, ProductCatName, ParentCatID, ChildCatFlag, delMark) Values(" + maxId + ", N'" + txtCategory.Text + "', 0, 0, 0)");
            ScriptManager.RegisterClientScriptBlock(this, GetType(), "myScript", "TostTrigger('success', 'Category info added');", true);
        }
        else
        {
            c.ExecuteQuery("Update ProductCategory set ProductCatName=N'" + txtCategory.Text + "' Where ProductCatID=" + maxId);
