...
public partial class admingenshopping_itemsubcategory : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (lblId.Text == "[New]")
        {
            c.ExecuteQuery("Insert Into ProductCategory(ProductCatID, ProductCatName, ParentCatID, ChildCatFlag, delMark) Values(" + maxId + ", N'" + txtCategory.Text + "'," + ddrMainCat.SelectedValue + " , 0, 0)");
            ScriptManager.RegisterClientScriptBlock(this, GetType(), "myScript", "TostTrigger('success', 'Sub Category info added');", true);
            
        }
        else
        {
            c.ExecuteQuery("Update ProductCategory set ProductCatName=N'" + txtCategory.Text + "', ParentCatID=" + ddrMainCat.SelectedValue + " Where ProductCatID=" + maxId);
