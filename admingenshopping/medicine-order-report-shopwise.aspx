<%@ Page Title="Shop wise Medicine Order Report" Language="C#" MasterPageFile="~/admingenshopping/MasterAdmin.master" AutoEventWireup="true" CodeFile="medicine-order-report-shopwise.aspx.cs" Inherits="admingenshopping_medicine_order_report_shopwise" %>
	...
	<div id="viewOrder" runat="server">
		...
		<div>
			...
			<asp:GridView ID="gvOrder" runat="server" 
				...
				AutoGenerateColumns="false" Width="100%" OnRowDataBound="gvOrder_RowDataBound">
				<RowStyle CssClass="" />
