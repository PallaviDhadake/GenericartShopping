<%@ Page Title="Banner Master | Genericart Admin Panel" Language="C#" MasterPageFile="~/admingenshopping/MasterAdmin.master" AutoEventWireup="true" CodeFile="banner-master.aspx.cs" Inherits="admingenshopping_banner_master" %>
			  ...
			  $("#<%= txtCat.ClientID %>").autocomplete({
				  source: function (request, response) {
					  $.ajax({
						  type: "POST",
						  contentType: "application/json; charset=utf-8",
						  url: "disease-product-master.aspx/GetCategories",
