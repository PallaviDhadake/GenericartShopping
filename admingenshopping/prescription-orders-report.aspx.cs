...
public partial class admingenshopping_prescription_orders_report : System.Web.UI.Page
{
    iClass c = new iClass();
        ...
        try
        {
            ...
            if (Request.QueryString["type"] != null)
            {
                switch (Request.QueryString["type"])
                {
                    ...
                    //        " On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 1 AND a.OrderType=2 Order By ordDate DESC, a.OrderID DESC";
                    //    break;
            ...
            {
                //strQuery = "Select DISTINCT a.OrderID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, isnull(a.DeviceType, '-') as DeviceType, b.CustomerName, " +
                //        " 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, a.OrderStatus From OrdersData a Inner Join CustomersData b  " +
                //        " On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus <> 0 AND a.OrderStatus <> 2  AND a.OrderType=2 Order By ordDate DESC, a.OrderID DESC";
    ...
    protected void gvOrder_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                litAnch.Text = "<a href=\"order-details.aspx?id=" + e.Row.Cells[0].Text + "&ref=rx\" class=\"gView\" title=\"View/Edit\"></a>";
                ...
                switch (e.Row.Cells[1].Text)
                {
                    ...
                    //    break;
                    //case "8":
                    //    litStatus.Text = "<div class=\"ordDenied\">Re Assigned</div>";
                    //    break;
