...
public partial class account_refund_request_report : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void RowDataBound(Object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (Request.QueryString["type"] != null)
                litAnch.Text = "<a href=\"order-details.aspx?type=" + Request.QueryString["type"] + "&ordId=" + e.Row.Cells[1].Text + "\" class=\"gView\" title=\"View/Edit\"></a>";
            else
                litAnch.Text = "<a href=\"order-details.aspx?ordId=" + e.Row.Cells[1].Text + "\" class=\"gView\" title=\"View/Edit\"></a>";
        }
    }
}