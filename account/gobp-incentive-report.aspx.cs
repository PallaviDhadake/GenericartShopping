...
public partial class account_gobp_incentive_report : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void gvGOBPIncentive_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                litAnch.Text = "<a href=\"customer-details.aspx?id=" + e.Row.Cells[0].Text + "&month=" + ddrMonth.SelectedItem.Text + "\" target=\"_blank\" class=\"frStats btn btn-sm btn-default\" data-fancybox-type=\"iframe\"><i class=\"fa fa-eye\" aria-hidden=\"true\"></i></a>";
            }
