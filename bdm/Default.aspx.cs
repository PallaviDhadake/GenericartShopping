...
public partial class management_Default : System.Web.UI.Page
{
    ...
    protected void cmdSign_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!c.IsRecordExist("Select EmpId From ManagementTeam Where MgmtUserId='" + txtShopCode.Text + "' And EmpLevel=11"))
            {
            ...
            {
                int franchId = Convert.ToInt32(c.GetReqData("ManagementTeam", "EmpId", "MgmtUserId='" + txtShopCode.Text + "'  And EmpLevel=11"));
                Session["adminBdm"] = franchId;
