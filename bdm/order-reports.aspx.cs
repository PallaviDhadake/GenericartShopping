...
public partial class bdm_order_reports : System.Web.UI.Page
{
    iClass c = new iClass();
        ...
        try
        {
                ...
                switch (Request.QueryString["type"])
                {
                    case "new":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile,  'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 1 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;

                    case "accepted":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 3 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;
                    case "denied":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 4 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;
                    case "processing":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 5 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;
                    case "shipped":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate,b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 6 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;
                    case "delivered":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 7 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;
                    case "monthly":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus<>0 AND a.MreqFlag=1 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;
                    //deniedbyshop
                    case "deniedbyshop":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Inner Join OrdersAssign c On a.OrderID=c.FK_OrderID Where a.OrderStatus<>0 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) AND c.OrdAssignStatus=2 AND c.OrdReAssign=0 Order By ordDate DESC, a.OrderID DESC";
                        break;
                    //cancelled b cust
                    case "cancelCust":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
                            "OrdersDetails Where FK_DetailOrderID= a.OrderID ) As ProductCount, LEFT (STUFF((Select ', ' + RTRIM(LTRIM(ProductName)) From ProductsData Where ProductID IN (Select FK_DetailProductID from OrdersDetails where FK_DetailOrderID = a.OrderID) FOR XML PATH('')), 1, 1, '' ) , 200) as CartProducts, a.OrderStatus From OrdersData a Inner Join CustomersData b On a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus = 2 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes')) Order By ordDate DESC, a.OrderID DESC";
                        break;
                    case "returned":
                        strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate, b.CustomerName, b.CustomerMobile, 'Rs. ' + Convert(varchar(20), a.OrderAmount) as OrdAmount, isnull(a.DeviceType, '-') as DeviceType, (Select COUNT(FK_DetailProductID) From " +
            ...
            else
            {
                strQuery = "Select DISTINCT a.OrderID, a.FK_OrderCustomerID, a.OrderDate, convert(varchar(20), a.OrderDate, 103) as ordDate , b.CustomerName, b.CustomerMobile,  " +
                    ...
                    " From OrdersData a Inner Join CustomersData b on a.FK_OrderCustomerID = b.CustomrtID Where a.OrderStatus <> 0 AND (a.OrderType=1 OR (a.OrderType=2 AND IsDecoded='yes'))" +
