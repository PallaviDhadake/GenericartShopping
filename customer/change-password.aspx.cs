...
public partial class customer_change_password : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtOldPass.Text == c.GetReqData("CustomersData", "CustomerPassword", "CustomrtID=" + Session["genericCust"]).ToString())
            {
                ...
                else
                {
                    ...
                    {
                        c.ExecuteQuery("Update CustomersData Set CustomerPassword='" + txtNewPass.Text + "' Where CustomrtID=" + Session["genericCust"]);
