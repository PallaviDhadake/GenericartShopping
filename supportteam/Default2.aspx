<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="supportteam_Default2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Genericart Shopping Support Team Login </title>
                ...
                <div class="login-box">
                    ...
                    <div class="card">
                        <div class="card-body login-card-body">
                            <p class="login-box-msg"><b>Support Team LogIn</b></p>
                            <div class="input-group mb-3">
                                <asp:TextBox ID="txtTeamUserID" runat="server" class="form-control" Placeholder="User Id"></asp:TextBox>
                            ...
                            <div id="request" runat="server" visible="true">
                                <div class="row">
                                    <div class="col-8">
                                        <div>
                                        </div>
                                    ...
                                    <div class="col-4">
                                        <asp:Button ID="btnRequest" runat="server" Text="Request OTP" CssClass="btn btn-primary btn-block" OnClick="btnRequest_Click" style="padding-left: 5px;" />
                                    </div>
                                </div>
                            </div>
