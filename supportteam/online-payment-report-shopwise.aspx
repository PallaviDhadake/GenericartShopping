<%@ Page Title="Shopwise Online Payment Report" Language="C#" MasterPageFile="~/supportteam/MasterSupport.master" AutoEventWireup="true" CodeFile="online-payment-report-shopwise.aspx.cs" Inherits="supportteam_online_payment_report_shopwise" %>
			...
			function onSucess(result) {
				...
				if (result != 1) {
					switch (result) {
						...
						case 4: TostTrigger('warning', 'Activity From Accounts Not Found'); break;
					}
				}
				else {
					TostTrigger('success', 'Payment Paid By Purchase');
				}
