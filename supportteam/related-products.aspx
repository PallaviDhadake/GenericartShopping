<%@ Page Title="Add Related Products to Sub Category" Language="C#" MasterPageFile="~/supportteam/MasterSupport.master" AutoEventWireup="true" CodeFile="related-products.aspx.cs" Inherits="supportteam_related_products" %>
<%@ MasterType VirtualPath="~/supportteam/MasterSupport.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css" />
	<link rel="stylesheet" href="/resources/demos/style.css" />
	<link href="../admingenshopping/css/bootstrap-tokenfield.css" rel="stylesheet" />
	<script src="../admingenshopping/js/bootstrap-tokenfield.js"></script>
