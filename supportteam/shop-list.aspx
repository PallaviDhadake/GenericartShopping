<%@ Page Title="Shop List" Language="C#" MasterPageFile="~/supportteam/MasterSupport.master" AutoEventWireup="true" CodeFile="shop-list.aspx.cs" Inherits="supportteam_shop_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div id="viewFranch" runat="server">
		<div class="formPanel table-responsive-md">
			<%--OnRowCommand="gvShops_RowCommand"--%> 
			<asp:GridView ID="gvShops" runat="server" CssClass="table table-striped table-bordered table-hover" GridLines="None"
				...
				<Columns>
					...
					<asp:BoundField DataField="FranchOwnerName" HeaderText="Owner Name">
						<ItemStyle Width="20%" />
					</asp:BoundField>
