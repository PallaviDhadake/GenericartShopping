<%@ Page Title="Add Product photos" Language="C#" MasterPageFile="~/supportteam/MasterSupport.master" AutoEventWireup="true" CodeFile="product-photos.aspx.cs" Inherits="supportteam_product_photos" %>
<%@ MasterType VirtualPath="~/supportteam/MasterSupport.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        .closeAnch {
            background: url(../admingenshopping/images/icons/deleteIco.png) no-repeat center center;
            display: block;
            height: 20px;
            width: 20px;
            position: absolute;
