...
public partial class supportteam_assign_order : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    private void FillShopGrid()
    {
        try
        {
            ...
            {
                strQuery = "Select FranchID, FranchName, FranchShopCode, FranchMobile From FranchiseeData Where FranchPinCode='" + zipcode + "' AND FranchActive=1 AND SUBSTRING(FranchShopCode,1,4)<>'GMDR' AND SUBSTRING(FranchShopCode,1,4)<>'GMOS' OR [FranchID] = 2062";
            }
            else
            {
