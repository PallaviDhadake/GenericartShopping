...
public partial class supportteam_change_password : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtOld.Text == c.GetReqData("SupportTeam", "TeamPassword", "TeamID=" + Session["adminSupport"] + "").ToString())
            {
                ...
                else
                {
                    ...
                    {
                        c.ExecuteQuery("Update SupportTeam Set TeamPassword='" + txtNew.Text + "' Where TeamID=" + Session["adminSupport"] + "");
