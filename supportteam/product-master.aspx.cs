...
public partial class supportteam_product_master : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtProdSKU.Text == "" || txtProdName.Text == "" || txtPriceMrp.Text == "" || txtPriceSale.Text == "" || 
                ...
                ddrMfr.SelectedIndex==0 || ddrUnit.SelectedIndex == 0 || ddrMainCategory.SelectedIndex==0 ||
            ...
            if (lblId.Text == "[New]")
            {
                c.ExecuteQuery("Insert Into ProductsData (ProductID, FK_MfgID, FK_UnitID, ProductSKU, ProductName, PriceMRP, PriceSale, " +
                    ...
                    " IsNotForOnlineSale, TaxPercent, TaxLessAmount) Values (" + maxId +
                    ", " + ddrMfr.SelectedValue + ", " + ddrUnit.SelectedValue + ", '" + txtProdSKU.Text + "', '" + txtProdName.Text +
                    "', " + Convert.ToDouble(txtPriceMrp.Text) + ", " + Convert.ToDouble(txtPriceSale.Text) + ", '" + txtPackaging.Text +
                    ...
                    "', " + featuredFlag + ", " + bestSeller + ", 0, '" + imgName + "', " + pillReminder + ", " + notOnlineSale +
                    ", " + ddrPercent.SelectedValue + ", " + txtTaxLess.Text + ")");
            ...
            else
            {
                c.ExecuteQuery("Update ProductsData Set FK_MfgID=" + ddrMfr.SelectedValue + ", FK_UnitID=" + ddrUnit.SelectedValue +
                    ", ProductSKU='" + txtProdSKU.Text + "', ProductName='" + txtProdName.Text + "', PriceMRP=" + Convert.ToDouble(txtPriceMrp.Text) +
                    ", PriceSale=" + Convert.ToDouble(txtPriceSale.Text) + ", PackagingType='" + txtPackaging.Text +
