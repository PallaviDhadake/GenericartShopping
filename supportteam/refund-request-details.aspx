<%@ Page Title="" Language="C#" MasterPageFile="~/supportteam/MasterSupport.master" AutoEventWireup="true" CodeFile="refund-request-details.aspx.cs" Inherits="supportteam_refund_request_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div id="Div1" runat="server">
		<div class="card">
			...
			<div id="refundRequest" runat="server">
				<div class="card-header">
					<h3 class="large colorLightBlue">Refund Process</h3>
				</div>
				<div class="card-body">
                    <asp:RadioButtonList ID="rbtregtype" runat="server" AppendDataBoundItems="true" RepeatDirection="Horizontal"
                        AutoPostBack="false">
                        <asp:ListItem Value="13">&nbsp; Refund Request &nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Value="14">&nbsp;&nbsp; Refund InProcess &nbsp;&nbsp; </asp:ListItem>
                        <asp:ListItem Value="15">&nbsp;&nbsp; Refund Process Completed &nbsp;&nbsp; </asp:ListItem>
                    </asp:RadioButtonList>

                    <div class="col-sm-1">
                        <span class="space30"></span>
                        <asp:Button ID="btnRefund" runat="server" CssClass="btn btn-md btn-primary" Text="Refund Process" OnClick="btnRefund_Click" />
                    </div>
				</div>
			</div>
		</div>
