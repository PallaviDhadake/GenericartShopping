<%@ Page Title="" Language="C#" MasterPageFile="~/supportteam/MasterSupport.master" AutoEventWireup="true" CodeFile="ordered-customer-details.aspx.cs" Inherits="supportteam_ordered_customer_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<table class="form_table">
					...
					<tr>
                        <td><span class="formLable bold_weight">Payment Type :</span></td>
                        <td><span class="formLable">
					...
					<tr>
                        <td><span class="formLable bold_weight">Payment Slip :</span></td>
                        <td><span class="formLable">
                            <asp:FileUpload ID="fuPaymentSlip" runat="server" /></span>                            
					...
					<tr>
						...
						<td><span class="formLable"><%= ordData[13] %></span> <asp:Button ID="btnRefresh" runat="server" Text="Refresh" CssClass="btn btn-sm btn-info ml-2" Visible="false" OnClick="btnRefresh_Click" /> 
                        <asp:Button ID="btnRefreshNew" runat="server" Text="Refresh Status" CssClass="btn btn-sm btn-info ml-2" Visible="true" OnClick="btnRefreshNew_Click" />    
                        <br /> <%= apiResponse %></td>
					</tr>
					<tr>
			...
			<%--<div class="card-body">
				<div class="">
					...
					<asp:DropDownList ID="orderStatus" CssClass="form-control" Width="200" runat="server">
						<asp:ListItem Value="0"><-Select-></asp:ListItem>
						<asp:ListItem Value="3">Accepted</asp:ListItem>
						<asp:ListItem Value="4">Denied</asp:ListItem>
						<asp:ListItem Value="5">Processing</asp:ListItem>
						<asp:ListItem Value="6">Shipped</asp:ListItem>
						<asp:ListItem Value="7">Delivered</asp:ListItem>
	...
	<asp:Button ID="btnAssignOrder" runat="server" CssClass="btn btn-sm btn-info" Text="Assign Order" OnClick="btnAssignOrder_Click"  />
	<asp:Button ID="btnHistory" runat="server" CssClass="btn btn-sm btn-info" Text="View History" OnClick="btnHistory_Click"  Visible="false" />
	<asp:Button ID="btnRefund" runat="server" CssClass="btn btn-sm btn-warning" Text="Refund" data-toggle="tooltip" data-placement="top" title="Initiate Refund Process" OnClientClick="return confirm('Are you sure to initiate Refund?');" OnClick="btnRefund_Click" Visible="false" />
	<a href="<%= rdrUrl %>" class="btn btn-sm btn-outline-dark">Back</a>

	<span class="space15"></span>

	<div id="RefundContent" runat="server" visible="false">
